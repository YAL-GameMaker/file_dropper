...
set extName=file_dropper
set dllName=file_dropper
set gmlDir14=%solutionDir%file_dropper.gmx
set gmlDir22=%solutionDir%file_dropper_yy
set gmlDir23=%solutionDir%file_dropper_23
